...
void parse_args(all_args_t* args, int argc, char* argv[])
{
  ...
  common.add_options()
    ...
    ("mme.full_net_name",   bpo::value<string>(&full_net_name)->default_value("V2X"), "Full name of the network")
    ("mme.short_net_name",  bpo::value<string>(&short_net_name)->default_value("V2X"),    "Short name of the network")
